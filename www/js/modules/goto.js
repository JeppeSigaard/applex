app.goTo = function(pageID, mods, callback){
    ...
    if(typeof mods !== 'undefined' && typeof mods.headerBtn !== 'undefined'){
        $('.header-btn').removeClass('menu back pause menu-close').addClass(mods.headerBtn);
    }
    ...
    return {from : activeID, to : pageID, mods : mods, callback : callback};
}
